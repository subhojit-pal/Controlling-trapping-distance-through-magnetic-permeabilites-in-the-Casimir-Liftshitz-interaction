...
OPEN(UNIT=10, FILE='results_15nm_phi0.01_retarded.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
OPEN(UNIT=20, FILE='free_energy_15nm_phi0.01_retarded.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
...
DO dloop=1,1500
  ...
  END DO
  print*, dist*1D9,' , ', 2.D0*pi*bsum*1D6
