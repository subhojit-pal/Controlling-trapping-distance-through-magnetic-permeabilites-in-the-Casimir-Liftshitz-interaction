...
OPEN(UNIT=10, FILE='results_20nm_phi0.01_retarded.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
OPEN(UNIT=20, FILE='free_energy_20nm_phi0.01_retarded.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
