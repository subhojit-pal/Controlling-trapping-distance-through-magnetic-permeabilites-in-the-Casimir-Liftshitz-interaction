...
OPEN(UNIT=10, FILE='results_15nm_phi0.01.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
OPEN(UNIT=20, FILE='free_energy_15nm_phi0.01.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
