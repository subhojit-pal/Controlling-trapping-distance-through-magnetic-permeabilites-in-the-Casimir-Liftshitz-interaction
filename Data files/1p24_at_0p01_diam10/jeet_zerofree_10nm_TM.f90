...
OPEN(UNIT=10, FILE='results_zerofreq_10nm.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
OPEN(UNIT=20, FILE='free_energy_10nm_zerofreq_TM.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
