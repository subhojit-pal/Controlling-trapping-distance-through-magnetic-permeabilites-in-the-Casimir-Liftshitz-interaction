...
OPEN(UNIT=10, FILE='results_5nm_phi0.01_DJA.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
OPEN(UNIT=20, FILE='free_energy_5nm_phi0.01_DJA.csv', STATUS='REPLACE', ACTION='WRITE')   !< open file for writing
